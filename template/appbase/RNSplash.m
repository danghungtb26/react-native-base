...
RCT_EXPORT_METHOD(show:(float)duration) {
  ...
  [RNSplash setAnimationForWindow:[[_presentedViewController view] window]
                             duration:duration
...
RCT_EXPORT_METHOD(hide:(float)duration) {
  ...
  [RNSplash setAnimationForWindow:[[_splashViewController view] window]
                             duration:duration
